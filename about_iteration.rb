...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Given an initial value as the parameter to inject, it applies the given brace block iteratively to this value.
  end
  ...
  # do + end will mean the file automagically gets closed.
